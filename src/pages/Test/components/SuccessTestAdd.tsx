    ...
    <div className="relative flex flex-col items-center justify-center py-8 space-y-4">
      ...
      >
        <div className="relative">
          ...
          {/* Main circle */}
          <div
            className={`relative w-24 h-24 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-2xl transition-all duration-700 ${
          ...
          <>
            {[...Array(12)].map((_, i) => (
              <div
                ...
                style={{
                  background: ["#0D52AF", "#3b82f6", "#60a5fa", "#93c5fd"][
                    i % 4
                  ],
        ...
        {/* Text content */}
        <h3
          className={`text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent transition-all duration-700 delay-500 ${
        ...
        <div
          className={`mt-4 px-6 py-2 bg-blue-100 rounded-full border-2 border-blue-300 transition-all duration-700 delay-900 ${
            show ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
          }`}
        >
          <p className="text-blue-700 font-semibold text-sm">Tests Confirmed</p>
        </div>
      </div>
      <style>{`
        @keyframes confetti {
